   ...
   <div className="flex flex-col items-center w-full">
    <ChevronDown className="text-gray-400" onClick={()=>{setconfirmLocationPanel(false)}} />
       <div className="w-full">
        ...
        <h4 className="text-gray-400 text-xl font-md border-b-2   py-1 border-yellow-600">Location 1</h4>
    </div>
   </div>
 
   <div className="">
        <h2 className="text-base ">Drop Location</h2>
        <h4 className="text-gray-400 text-xl font-md border-b-2 py-1 border-yellow-600">Location 2</h4>
    </div>
